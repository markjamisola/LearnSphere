            ...
            <v-list-item @click="$router.push('/home')" class="text-center">
              <v-list-item-icon>
                <v-icon
                  large
                  :color="
                    ['/home', '/csc102'].includes($route.path) ? 'deep-purple-darken-3' : 'white'
                  "
                >
                  mdi-home
                </v-icon>
      ...
      <v-main>
        ...
        <v-container fluid>
          <v-row>
              ...
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                ...
                <v-card-text>
                  <v-btn
                    ...
                    block
                    @click="
                      showVideo('https://youtu.be/rcyeHdx0Qv4?feature=shared')
                    "
                    >Watch Video</v-btn
                  >
                </v-card-text>
              ...
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                ...
                <v-card-text>
                  <v-btn
                    ...
                    block
                    @click="
                      showVideo('https://youtu.be/_RrxqiB_pfE?feature=shared')
                    "
                    >Watch Video</v-btn
                  >
                </v-card-text>
            ...
            <v-col cols="12" md="6">
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                <v-card-title class="text-center font-weight-black pb-10">Propositional Logic</v-card-title>
                <v-card-text>
                  <v-btn
                    elevation="10"
                    color="#803D3B"
