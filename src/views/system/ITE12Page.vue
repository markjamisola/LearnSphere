            ...
            <v-list-item @click="$router.push('/home')" class="text-center">
              <v-list-item-icon>
                <v-icon
                  large
                  :color="
                    ['/home', '/ite12'].includes($route.path) ? 'deep-purple-darken-3' : 'white'
                  "
                >
                  mdi-home
                </v-icon>
      ...
      <v-main>
        ...
        <v-container fluid>
          <v-row>
              ...
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                ...
                <v-card-text>
                  <v-btn
                    ...
                    block
                    @click="
                      showVideo('https://youtu.be/JgQs1AgMU00?si=JH1-ZiMV92PXhrKl')
                    "
                    >Watch Video</v-btn
                  >
                </v-card-text>
              ...
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                ...
                <v-card-text>
                  <v-btn
                    ...
                    block
                    @click="
                      showVideo('https://youtu.be/-33idp61W2w?si=_xtMyJ6__Ut6Ju43')
                    "
                    >Watch Video</v-btn
                  >
                </v-card-text>
            ...
            <v-col cols="12" md="6">
              <v-card class="mb-5" color="#FAEED1" dark elevation="10">
                <v-card-title class="text-center font-weight-black pb-10">Selection Structures</v-card-title>
                <v-card-text>
                  <v-btn
                    elevation="10"
                    color="#803D3B"
